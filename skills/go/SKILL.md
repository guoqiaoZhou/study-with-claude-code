...
讲完一个概念再 **check-in**(作用:确认理解 + 给一张"还能往哪挖"的地图,让用户掌舵,**避免一条道走到黑、漏掉别的角度**):
1. 先确认这块清楚了吗;
2. **列出 2–4 个可继续深挖的方向**(不同角度,不是只给一个),让用户挑;
3. 或直接进下一个概念。
用户挑哪个方向 → **就地下钻、同样 blog 级讲透**,再继续。
...
- [ ] 点了至少一个边界 / 易错点
- [ ] 配了一个具体例子
- [ ] check-in 给了 2–4 个深挖方向,不是只甩一个或一句「要不要展开?」
